.class public Lcom/car/speech/LocalMusic;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/car/speech/LocalMusic$DownLoadTask;,
...
.field mDownLoadTask:Lcom/car/speech/LocalMusic$DownLoadTask;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/car/speech/LocalMusic;->ROOT_PATH:Ljava/lang/String;

    const/4 v0, 0x1

    sput-boolean v0, Lcom/car/speech/LocalMusic;->USE_SYSTEM_MUSIC:Z

    const/4 v0, 0x0

    sput v0, Lcom/car/speech/LocalMusic;->mKwStatus:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mService:Lcom/android/music/IMediaPlaybackService;

    iput v4, p0, Lcom/car/speech/LocalMusic;->mFileDownloadIndex:I

    iput v4, p0, Lcom/car/speech/LocalMusic;->mCurReqId:I

    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mDownLoadTask:Lcom/car/speech/LocalMusic$DownLoadTask;

    new-instance v1, Lcom/car/speech/LocalMusic$1;

    invoke-direct {v1, p0}, Lcom/car/speech/LocalMusic$1;-><init>(Lcom/car/speech/LocalMusic;)V

    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mClient:Landroid/media/MediaScannerConnection$MediaScannerConnectionClient;

    new-instance v1, Lcom/car/speech/LocalMusic$2;

    invoke-direct {v1, p0}, Lcom/car/speech/LocalMusic$2;-><init>(Lcom/car/speech/LocalMusic;)V

    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mMediaScannerListener:Landroid/media/IMediaScannerListener$Stub;

    new-instance v1, Lcom/car/speech/LocalMusic$3;

    invoke-direct {v1, p0}, Lcom/car/speech/LocalMusic$3;-><init>(Lcom/car/speech/LocalMusic;)V

    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mHandler:Landroid/os/Handler;
    ...
    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mCursorCols:[Ljava/lang/String;

    new-instance v1, Lcom/car/speech/LocalMusic$4;

    invoke-direct {v1, p0}, Lcom/car/speech/LocalMusic$4;-><init>(Lcom/car/speech/LocalMusic;)V

    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    new-instance v1, Lcom/car/speech/LocalMusic$5;

    invoke-direct {v1, p0}, Lcom/car/speech/LocalMusic$5;-><init>(Lcom/car/speech/LocalMusic;)V

    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mRebind:Ljava/lang/Runnable;

    new-instance v1, Lcom/car/speech/LocalMusic$6;

    invoke-direct {v1, p0}, Lcom/car/speech/LocalMusic$6;-><init>(Lcom/car/speech/LocalMusic;)V

    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mMediaScannerRebind:Ljava/lang/Runnable;

    iput-object p1, p0, Lcom/car/speech/LocalMusic;->mContext:Landroid/content/Context;

    invoke-static {p1}, Lcom/car/speech/LocalMusic;->isKuwoInstalled(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_0

    sput-boolean v4, Lcom/car/speech/LocalMusic;->USE_SYSTEM_MUSIC:Z

    :cond_0
    const-string v1, "com.android.music"

    invoke-static {p1, v1}, Lcom/car/utils/Util;->isApkInstalled(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-direct {p0, p1}, Lcom/car/speech/LocalMusic;->bindMusicService(Landroid/content/Context;)V

    :cond_1
    invoke-direct {p0, p1}, Lcom/car/speech/LocalMusic;->bindMediaScannerService(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/car/speech/LocalMusic;->mToast:Landroid/widget/Toast;
    ...
    iget-object v1, p0, Lcom/car/speech/LocalMusic;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$000(Lcom/car/speech/LocalMusic;)Lcom/android/music/IMediaPlaybackService;
    .locals 1

    iget-object v0, p0, Lcom/car/speech/LocalMusic;->mService:Lcom/android/music/IMediaPlaybackService;

    return-object v0
.end method

.method static synthetic access$100(Lcom/car/speech/LocalMusic;)Landroid/media/MediaScannerConnection$MediaScannerConnectionClient;
    .locals 1

    iget-object v0, p0, Lcom/car/speech/LocalMusic;->mClient:Landroid/media/MediaScannerConnection$MediaScannerConnectionClient;
...
.method static synthetic access$200()Z
    ...
    sget-boolean v0, Lcom/car/speech/LocalMusic;->USE_SYSTEM_MUSIC:Z

    return v0
.end method

.method static synthetic access$300(Lcom/car/speech/LocalMusic;Landroid/content/Context;)V
    .locals 0
...
.method static synthetic access$400(Lcom/car/speech/LocalMusic;Landroid/content/Context;)V
    .locals 0
...
.method static synthetic access$500(Lcom/car/speech/LocalMusic;)Landroid/media/IMediaScannerListener$Stub;
    .locals 1

    iget-object v0, p0, Lcom/car/speech/LocalMusic;->mMediaScannerListener:Landroid/media/IMediaScannerListener$Stub;

    return-object v0
.end method

.method private bindMediaScannerService(Landroid/content/Context;)V
    .locals 8

    const-wide/16 v6, 0x7d0

    iget-object v2, p0, Lcom/car/speech/LocalMusic;->mMediaScannerService:Landroid/media/IMediaScannerService;
    ...
    iget-object v2, p0, Lcom/car/speech/LocalMusic;->mHandler:Landroid/os/Handler;

    iget-object v3, p0, Lcom/car/speech/LocalMusic;->mMediaScannerRebind:Ljava/lang/Runnable;
...
.method private bindMusicService(Landroid/content/Context;)V
    .locals 8

    const-wide/16 v6, 0x7d0

    iget-object v2, p0, Lcom/car/speech/LocalMusic;->mService:Lcom/android/music/IMediaPlaybackService;
    ...
    iget-object v3, p0, Lcom/car/speech/LocalMusic;->mRebind:Ljava/lang/Runnable;
...
.method private downloadUrlToStream(Ljava/lang/String;Ljava/io/OutputStream;Ljava/lang/String;I)Z
    ...
    invoke-direct {v6, v15, v0}, Ljava/io/BufferedInputStream;-><init>(Ljava/io/InputStream;I)V
    :try_end_0
    ...
    invoke-direct {v9, v0, v15}, Ljava/io/BufferedOutputStream;-><init>(Ljava/io/OutputStream;I)V
    :try_end_1
    ...
    invoke-virtual {v9, v2, v15, v7}, Ljava/io/BufferedOutputStream;->write([BII)V
    ...
    iget v15, v0, Lcom/car/speech/LocalMusic;->mFileDownloadIndex:I
    :try_end_2
...
.method public static isKuwoPlaying()Z
    ...
    sget v1, Lcom/car/speech/LocalMusic;->mKwStatus:I
...
.method doPlay([J)V
    ...
    iget-object v2, v0, Lcom/car/speech/LocalMusic;->mContext:Landroid/content/Context;
    ...
    :cond_1
    sget-boolean v2, Lcom/car/speech/LocalMusic;->USE_SYSTEM_MUSIC:Z
    ...
    iget-object v2, v0, Lcom/car/speech/LocalMusic;->mService:Lcom/android/music/IMediaPlaybackService;
...
.method globalSearchAgain(Ljava/lang/String;)[J
    ...
    iget-object v4, v0, Lcom/car/speech/LocalMusic;->mContext:Landroid/content/Context;
    ...
    iget-object v4, v0, Lcom/car/speech/LocalMusic;->mCursorCols:[Ljava/lang/String;
...
.method public next()V
    ...
    iget-object v0, p0, Lcom/car/speech/LocalMusic;->mHandler:Landroid/os/Handler;
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object v0, p0, Lcom/car/speech/LocalMusic;->mService:Lcom/android/music/IMediaPlaybackService;
    ...
    iput-object v0, p0, Lcom/car/speech/LocalMusic;->mMediaScannerService:Landroid/media/IMediaScannerService;
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    iput-object v2, p0, Lcom/car/speech/LocalMusic;->mService:Lcom/android/music/IMediaPlaybackService;

    iget-object v0, p0, Lcom/car/speech/LocalMusic;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/car/speech/LocalMusic;->mRebind:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, Lcom/car/speech/LocalMusic;->mMediaScannerService:Landroid/media/IMediaScannerService;

    iget-object v0, p0, Lcom/car/speech/LocalMusic;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/car/speech/LocalMusic;->mMediaScannerRebind:Ljava/lang/Runnable;
...
.method public playAll()V
    ...
    new-instance v1, Lcom/car/speech/LocalMusic$8;

    invoke-direct {v1, p0}, Lcom/car/speech/LocalMusic$8;-><init>(Lcom/car/speech/LocalMusic;)V
...
.method public playSong(Ljava/lang/String;)[J
    .locals 3

    invoke-virtual {p0, p1}, Lcom/car/speech/LocalMusic;->search(Ljava/lang/String;)[J

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lcom/car/speech/LocalMusic;->globalSearchAgain(Ljava/lang/String;)[J
...
.method public playSongAgain(Ljava/lang/String;Z)V
    ...
    new-instance v1, Lcom/car/speech/LocalMusic$7;

    invoke-direct {v1, p0, p1}, Lcom/car/speech/LocalMusic$7;-><init>(Lcom/car/speech/LocalMusic;Ljava/lang/String;)V
...
.method saveFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v11, Lcom/car/speech/LocalMusic;->ROOT_PATH:Ljava/lang/String;
    ...
    sget-object v12, Lcom/car/speech/LocalMusic;->ROOT_PATH:Ljava/lang/String;
    ...
    :try_start_2
    iget v11, p0, Lcom/car/speech/LocalMusic;->mCurReqId:I

    invoke-direct {p0, p1, v5, p2, v11}, Lcom/car/speech/LocalMusic;->downloadUrlToStream(Ljava/lang/String;Ljava/io/OutputStream;Ljava/lang/String;I)Z
    :try_end_2
...
.method public setItemList(Ljava/util/ArrayList;)V
    ...
    iput-object p1, p0, Lcom/car/speech/LocalMusic;->mList:Ljava/util/ArrayList;

    iget-object v1, p0, Lcom/car/speech/LocalMusic;->mList:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/car/speech/LocalMusic;->mHandler:Landroid/os/Handler;
